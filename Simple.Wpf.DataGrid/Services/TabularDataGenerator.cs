...
public static class TabularDataGenerator
{
    ...
    private static object GenerateDateTime() =>
        DateTime.Now.AddDays(IntegerRandom.Next(-4000, 9000))
            .Date;

    private static object GenerateInteger() => IntegerRandom.Next(-100000, 100000);

    private static object GenerateDouble() => DoubleRandom.NextDouble();
