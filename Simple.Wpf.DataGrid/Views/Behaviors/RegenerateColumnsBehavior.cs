...
public sealed class RegenerateColumnsBehavior : Behavior<System.Windows.Controls.DataGrid>
{
    ...
    protected override void OnAttached()
    {
        ...
        AssociatedObject.AutoGeneratedColumns += HandleColumnsGenerated;

        AssociatedObject.Loaded += HandleLoaded;
        AssociatedObject.Unloaded += HandleUnloaded;
    }

    private void HandleUnloaded(object sender, RoutedEventArgs e) => _disposable.Dispose();
    ...
    private void HandleColumnsGenerated(object sender, EventArgs args)
    {
        _columns.Clear();
        _columnsName.Clear();
    ...
    {
        public NamedDataGridTemplateColumn(string columnName) => ColumnName = columnName;
