    ...
    IComparable<DynamicDataViewModel>, IComparable
{
    ...
    public int CompareTo(object obj) => CompareTo((DynamicDataViewModel)obj);

    public int CompareTo(DynamicDataViewModel other) => string.Compare(Id, other.Id, StringComparison.Ordinal);
    ...
    public static void Reset() => PropertyDescriptors = null;
